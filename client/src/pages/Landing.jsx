  ...
  return (
    <>
      <div className="min-w-full min-h-screen bg-[#eef] select-none py-[4.4rem] md:py-[5.6rem]">
        ...
        <div className="z-20 absolute -left-32 sm:-left-10 -top-44 md:-top-20 w-80 h-80 bg-[#40f8] blur-[50px] rounded-full animate-[projection_8s_infinite]" />
        <div className="z-10 absolute -left-40 sm:-left-16 -top-32 md:-top-12 w-1/3 h-80 bg-gradient-to-br from-[#88f6] to-[#77f8] blur-[100px] rounded-full animate-[projection_7s_infinite]" />
