  ...
  return (
    <>
      <div className="min-w-full min-h-screen bg-[#eef] select-none py-[4.4rem] md:py-[5.6rem]">
        ...
        >
          <div className="z-20 absolute -right-40 md:-right-20 -bottom-44 md:-bottom-32 w-60 h-60 bg-[#50fa] blur-[60px] rounded-full animate-[projection_8s_infinite]" />
          <div className="z-10 absolute -right-32 md:right-12 -bottom-52 md:-bottom-32 w-80 h-80 bg-gradient-to-br from-[#88fa] to-[#77f8] blur-[100px] rounded-full animate-[projection_10s_infinite]" />
          <img
            src={Image1}
            alt="IQ"
        ...
        <div className="z-20 absolute -left-32 sm:-left-10 -top-44 md:-top-20 w-80 h-80 bg-[#50f8] blur-[50px] rounded-full animate-[projection_10s_infinite]" />
        <div className="z-10 absolute left-40 sm:-left-20 -top-32 md:-top-12 w-1/3 h-80 bg-gradient-to-br from-[#88f6] to-[#77fa] blur-[100px] rounded-full animate-[projection_12s_infinite]" />
