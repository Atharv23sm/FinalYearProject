  ...
  return (
    <>
      <div className="min-w-full min-h-screen bg-gradient-to-b from-[#88f4] to-[#fff]">
        ...
        <div className="relative overflow-hidden h-fit px-4 py-4 sm:py-16 flex flex-col justify-center items-center gap-8 sm:gap-16 m-4 md:m-8 lg:m-12 bg-cover bg-top md:bg-center rounded-lg shadow-lg" style={{ backgroundImage: `url('/grid.jpg')` }}>
